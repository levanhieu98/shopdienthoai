...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Quản Lý VHMobile</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="javascript:void(0);"><i class="material-icons">shopping_cart</i>Bán Hàng</a></li>
                            <li><a href="javascript:void(0);"><i class="material-icons">favorite</i>Thích</a></li>
                            <li role="seperator" class="divider"></li>
                            <li><a href="thoat.php"><i class="material-icons">input</i>Đăng Xuất</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2019 - 2020 <a href="javascript:void(0);">Quản Lý VHMobile </a>.
                </div>
                <div class="version">
                    <b>Version: </b> 9.9.9
                </div>
    ...
    <section class="content">
        ...
        switch ($p) {
            ...
            case "them_nhacungcap":
             ...
             case "them_sanpham":
              ...
              case "sua_sanpham":
                ...
                break;
             case "ds_khachhang":
                require("danhsachKH.php");
                break;
             case "ds_hoadon":
                require("danhsachDH.php");
                break;
             case "dh_chitiet":
                require("donhangchitiet.php");
                break;
            case "sl_kho":
                require("quanlykho.php");
                break;
            case "them_kho":
                require("quanlykho_them.php");
                break;
             case "ds_ql":
                require("danhsachQL.php");
                break;
            case "them_ql":
                require("themQL.php");
                break;
            case "sua_ql":
                ...
                break;
            case "ds_gg":
                require("danhsachGGia.php");
                break;
            case "them_gg":
                require("themGGia.php");
                break;
            case "sua_gg":
                require("suaGG.php");
                break;
            case "ds_bl":
                require("danhsachBL.php");
                break;
            default:
